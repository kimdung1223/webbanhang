...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/taytbc.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div id="cont_left">
              	<img src="hinh/sp/Mas-Bi -Taytebao/tttbc.jpg"/>
              </div>
              <div id="cont_right">
				...
				include "autoload.php";
              	...
              	<div id="cont">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;Công Dụng:<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Dưỡng môi hồng hào, tươi tắn.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Tẩy tế bào chết, trị môi khô -  nứt nẻ.<br/>       
                 </div>
                 <div>
