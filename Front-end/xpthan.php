...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/xpthan.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div class="content"><!-- InstanceBeginEditable name="EditRegion1" -->
             <div id="cont_left">
              	<img src="hinh/sp/Xà phòng/than.jpg"/>
              </div>
              <div id="cont_right">
           		<div id="cont_right_title"><?php 
						$obj = new sanpham();
						$data=$obj->getOne("XPTT");
