...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/nguhoa.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div class="content"><!-- InstanceBeginEditable name="EditRegion1" -->
             <div id="cont_left">
              	<img src="hinh/sp/bột/nguhoahat.jpg"/>
              </div>
              <div id="cont_right">
				...
				include "autoload.php";
              	...
              	<div id="cont">
                    	&nbsp;&nbsp;&nbsp;&nbsp;Thành Phần: 100% các loại hạt thảo dược nguyên chất.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;Công Dụng:<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Làm mát da.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Hút đi mủ trong mụn, kiểm soát lượng dầu.<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp; - Giúp da mặt căng bóng, trắng sáng, .<br/>
