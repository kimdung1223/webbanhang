...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/nghe.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
   	...
   	<div id="header">
        ...
        <div id="main">
            ...
            <div class="content"><!-- InstanceBeginEditable name="EditRegion1" -->
			 <div id="cont_left">
              	<img src="hinh/sp/bột/bot-nghe.png"/>
              </div>
              <div id="cont_right">
              	...
              	<div id="cont">
                    	&nbsp;&nbsp;&nbsp;&nbsp;Thành Phần: 100% từ củ nghệ nguyên chất.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;Công Dụng:<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Giúp giảm cân, lưu thông và lọc máu.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Giúp chống ung thư, kháng viêm, giảm nguy cơ nhiễm trùng.<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp; - Giúp liền sẹo.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;-Chữa bệnh viêm khớp, tiêu hóa. <br/>
                        
                 </div>
                 <div>
                 	<div id="pro_price"> &nbsp;&nbsp;&nbsp;&nbsp;Giá : 50.000</div>
