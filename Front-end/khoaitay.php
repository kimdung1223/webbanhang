...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/khoaitay.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div id="cont_left">
              	<img src="hinh/sp/bột/botkhoaitay.jpg"/>
              </div>
              <div id="cont_right">
				...
				include "autoload.php";
              	...
              	<div id="cont">
                    	&nbsp;&nbsp;&nbsp;&nbsp;Thành Phần: 100% từ khoai tây nguyên chất.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;Công Dụng:<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Chứa nhiều vitamin C giúp da sáng trắng.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Tạo độ săn chắc cho da, giúp ngăn ngừa lão hoá.<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp; - Cung cấp dưỡng chất tái tạo làn da, Trị mụn.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Chữa lành vết thương, vết rạn da. <br/>
              ...
              <div class="fb-comments" data-href="https://www.facebook.com/botkanshop" data-width="943" data-numposts="5"></div></div>
