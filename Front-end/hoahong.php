...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/hoahong.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div id="cont_left">
              	<img src="hinh/sp/bột/bothoahong.jpg"/>
              </div>
              <div id="cont_right">
				...
				include "autoload.php";
						$obj = new sanpham();
						$data=$obj->getOne("HH01");
						echo $data[0]["tensp"];?> </div>
              	<div id="cont">
                    	&nbsp;&nbsp;&nbsp;&nbsp;Thành Phần: 100% từ hoa hồng nguyên chất.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;Công Dụng:<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Tái tạo độ ẩm đàn hồi săn chắc da. Cân bằng độ PH cho da.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;-  Làm da trắng hồng, mịn màng. Mang lại sức khoẻ cho làn da.<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp; - Ngăn chặn quá trình lão hoá của da, giảm nhăn nhiệi quả.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Thích hợp với mọi loại da. <br/>
                        
                 </div>
                 <div>
                 	<div id="pro_price"> &nbsp;&nbsp;&nbsp;&nbsp;Giá : 35.000</div>
