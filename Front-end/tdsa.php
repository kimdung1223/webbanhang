...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/tdsa.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div id="cont_left">
              	<img src="hinh/sp/dầu dưỡng/tdsachanh.jpg"/>
              </div>
              <div id="cont_right">
				...
				include "autoload.php";
						$obj = new sanpham();
						$data=$obj->getOne("TDSC");
						echo $data[0]["tensp"];?></div>
              	<div id="cont">
                    	&nbsp;&nbsp;&nbsp;&nbsp;Thành Phần: 100% nguyên chất.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;Tinh dầu Sả Chanh giúp giảm đau, chống trầm cảm, chống nhiễm khuẩn, chống đầy hơi, khử mùi, lợi tiểu, giải nhiệt, diệt nấm mốc.
Hương thơm giúp hưng phấn tinh thần, giải tỏa căng thẳng, lo âu.
Dùng xông để sát khuẩn, khử mùi hôi tanh, đuổi muỗi và côn trùng rất hiệu quả.
                 ...
                 <div>
                 	<div id="pro_price"> &nbsp;&nbsp;&nbsp;&nbsp;Giá : 45.000</div>
                   <div id="pro_cart">&nbsp;&nbsp;&nbsp;&nbsp;	<button onclick="self.location.href='../Front-end/giohang.php?ac=add&amp;id=<?php echo $data[0]["masp"];?>'">Mua hàng</button>
                    </div>
                 </div>
