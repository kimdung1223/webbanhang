...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/suatuoi.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div id="cont_left">
              	<img src="hinh/sp/khác/suatuoi.jpg"/>
              </div>
              <div id="cont_right">
				...
				include "autoload.php";
						$obj = new sanpham();
						$data=$obj->getOne("ST06");
						echo $data[0]["tensp"];?></div>
              	<div id="cont">
                    	&nbsp;&nbsp;&nbsp;&nbsp;Trong 100ml sữa chứa: 65 calories, 3.4g protein(đạm), 4.8 carbs, 3.6g rất tốt cho ai ăn kiêng hoặc muốn lên cơ,giảm mỡ.<br/>

&nbsp;&nbsp;&nbsp;&nbsp;Tác dụng của sữa bò nguyên chất tự nhiên: <br/>
&nbsp;&nbsp;&nbsp;&nbsp;✔ Đắp mặt nạ dưỡng da<br/>
&nbsp;&nbsp;&nbsp;&nbsp;✔ Pha với cà phê uống <br/>
&nbsp;&nbsp;&nbsp;&nbsp;✔ Tẩy trang an toàn và hiệu quả.<br/>
                        
                 </div>
                 <div>
                 	<div id="pro_price"> &nbsp;&nbsp;&nbsp;&nbsp;Giá : 2.000</div>
