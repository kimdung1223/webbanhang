...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/sontuoi.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
        ...
        <div id="main">
            ...
            <div id="cont_left"> <img src="hinh/sp/Son/son-tuoi.jpg"/> </div>
                <div id="cont_right">
                  ...
                  <div id="cont"> &nbsp;&nbsp;&nbsp;&nbsp;Thành Phần: 100% tự nhiên.<br/>
                     &nbsp;&nbsp;&nbsp;&nbsp; ✔ Son bền màu, lì màu, dưỡng môi, chống nắng, nguyên liệu thiên nhiên 100% không chì, không chất bảo quản <br/>
                          &nbsp;&nbsp;&nbsp;&nbsp; ✔Có 10 màu<br/>
                            &nbsp;&nbsp;&nbsp;&nbsp; - Đỏ cam - Đỏ hồng - Đỏ tươi - Đỏ nude<br/>
                                    &nbsp;&nbsp;&nbsp;&nbsp; - Cam đỏ - Cam đào - Cam đất<br/>
                                          &nbsp;&nbsp;&nbsp;&nbsp; - Hồng ấn - Hồng dưa hấu - Hồng cam<br/>
                  </div>
                  <div>
                    <div id="pro_price"> &nbsp;&nbsp;&nbsp;&nbsp;Giá : 90.000</div>
                    <div id="pro_cart">&nbsp;&nbsp;&nbsp;&nbsp;
