...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/daunanh.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div id="cont_left">
              	<img src="hinh/sp/bột/botdaunanh.jpg"/>
            </div>
            <div id="cont_right">
              	...
              	<div id="cont">
                    	&nbsp;&nbsp;&nbsp;&nbsp;Thành Phần: 100% từ hạt đậu nành nguyên chất.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;Công Dụng:<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Dưỡng trắng hồng da.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Tẩy tế bào chết, làm sạch da.<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp; - Cung cấp dưỡng chất tái tạo làn da, Trị mụn.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Thích hợp với da thường, da khô, da hỗn hợp. <br/>
                        
              </div>
                 <div>
                 	<div id="pro_price"> &nbsp;&nbsp;&nbsp;&nbsp;Giá : 17.000</div>
