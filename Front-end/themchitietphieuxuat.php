...
<fieldset>
<legend>Nhập thông tin chi tiết phiếu xuất</legend>
<form action="themchitietphieuxuat.php" method="post" enctype="multipart/form-data">
    ...
    <tr>
        ...
        <td><select name="mapx" >
                            <?php
                                foreach($b as $v)
                                { ?>
                                    <option value="<?php echo $v["mapx"]; ?>"><?php echo $v["mapx"]; ?></option>
                                    <?php
                                } ?>
                                </select></td>
    </tr>
...
{ ?>
    <tr>
        ...
        <td>
        <a href="xoachitietphieuxuat.php?mapx=<?php echo $r["mapx"]; ?>">Xóa</a>&nbsp;
        </td>
    </tr>
    <?php
}
