...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/daudua.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div class="content"><!-- InstanceBeginEditable name="EditRegion1" --><div id="cont_left">
              	<img src="hinh/sp/dầu dưỡng/daudua.jpg"/>
              </div>
              <div id="cont_right">
				...
				include "autoload.php";
						$obj = new sanpham();
						$data=$obj->getOne("DD02");
						echo $data[0]["tensp"];?> </div>
              	<div id="cont">
                    	&nbsp;&nbsp;&nbsp;&nbsp;Thành Phần: 100% nguyên chất.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;Công Dụng:<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Có thể sử dụng dầu dừa làm son dưỡng môi , massage ,hoặc thoa trực tiếp lên tóc giúp tóc mượt và mau dài , tương tự ứng dụng cho mi mắt làm mascara dầu dừa..<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;-  làm giảm vết thâm quầng, làm nước súc miệng.<br/>
                      
                        
                 </div>
                 <div>
                 	<div id="pro_price"> &nbsp;&nbsp;&nbsp;&nbsp;Giá : 40.000</div>
