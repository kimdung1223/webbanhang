...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/yenmach.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div id="cont_left">
              	<img src="hinh/sp/bột/botyenmach.jpg"/>
              </div>
              <div id="cont_right">
              	...
              	<div id="cont">
                    	&nbsp;&nbsp;&nbsp;&nbsp;Thành Phần: 100% từ hạt yến mạch nguyên chất.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;Công Dụng:<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Dưỡng trắng hồng da.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Tẩy tế bào chết, làm sạch da.<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp; - Se khít lỗ chân lông, làm dịu da cháy nắng.<br/>
