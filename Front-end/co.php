...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/co.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div class="content"><!-- InstanceBeginEditable name="EditRegion1" --><div id="cont_left">
              	<img src="hinh/sp/khác/coquet.jpg"/>
              </div>
              <div id="cont_right">
           		<div id="cont_right_title"><?php 
						$obj = new sanpham();
						$data=$obj->getOne("CQMN");
						echo $data[0]["tensp"];?> </div>
              	<div id="cont">
                    	&nbsp;&nbsp;&nbsp;&nbsp;Cọ mask cán nhựa cứng cáp, đầu cọ mềm, giúp việc trộn và đắp các mặt nạ thiên nhiên trở nên dễ dàng, tiện dụng, sạch sẽ, nhanh chóng hơn. <br/>

                        
                 </div>
                 <div>
                 	<div id="pro_price"> &nbsp;&nbsp;&nbsp;&nbsp;Giá : 10.000</div>
                    <div id="pro_cart">&nbsp;&nbsp;&nbsp;&nbsp;
