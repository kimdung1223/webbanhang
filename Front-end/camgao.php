...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/camgao.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div class="content"><!-- InstanceBeginEditable name="EditRegion1" --> <div id="cont_left">
              	<img src="hinh/sp/bột/botcamgao.jpg"/>
              </div>
              <div id="cont_right">
              	...
              	<div id="cont">
                    	&nbsp;&nbsp;&nbsp;&nbsp;Thành Phần: 100% từ gạo xay nguyên chất.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;Công Dụng:<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Dưỡng trắng hồng da.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Giúp trị nám, tàn nhang..<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp; - Cung cấp dưỡng chất tái tạo làn da, Trị mụn.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;- Thích hợp với mọi loại da. <br/>
                        
                </div>
                 <div>
                 	<div id="pro_price"> &nbsp;&nbsp;&nbsp;&nbsp;Giá : 15.000</div>
                    <div id="pro_cart">&nbsp;&nbsp;&nbsp;&nbsp;
                   		<button onclick="self.location.href='../Front-end/giohang.php?ac=add&amp;id=<?php echo $data[0]["masp"];?>'">Mua hàng</button></div>
                 </div>
