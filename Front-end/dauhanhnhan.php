...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/dauhanhnhan.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div id="cont_left">
              	<img src="hinh/sp/dầu dưỡng/dauhanhnhan.jpg"/>
              </div>
              <div id="cont_right">
				...
				include "autoload.php";
              	...
              	<div id="cont">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;-  Xóa thâm quầng mắt
<br/>
&nbsp;&nbsp;&nbsp;&nbsp;- Sử dụng phổ biến trong massage trị liệu do hấp thụ tốt qua da giúp da mềm mịn, không gây nhờn dính.<br/>
