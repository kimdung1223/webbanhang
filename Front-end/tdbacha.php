...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/tdbacha.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div id="cont_left">
              	<img src="hinh/sp/dầu dưỡng/tinhdaubacha.jpg"/>
              </div>
              <div id="cont_right">
           		<div id="cont_right_title"><?php 
						$obj = new sanpham();
						$data=$obj->getOne("TDBH");
