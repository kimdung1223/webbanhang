...
<fieldset>
<legend>Nhập thông tin chi tiết đơn hàng</legend>
<form action="themchitietdonhang.php" method="post" enctype="multipart/form-data">
<table class="tb" align="center">
    ...
    <tr>
     ...
     <tr>
    	<td>Số lượng :</td>
        <td><input type="text" name="sl" placeholder="Phải nhập số!" /></td>
    </tr>
     <tr>
    	<td>Đơn giá :</td>
        <td><input type="text" name="dg"placeholder="Phải nhập số!" /></td>
    </tr>
     <tr>
    	<td>Thành tiền :</td>
...
{ ?>
    <tr>
        ...
        <td>
        <a href="xoachitietdonhang.php?madh=<?php echo $r["madh"]; ?>">Xóa</a>
        </td>
    </tr>
    <?php
}
