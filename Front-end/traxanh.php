...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/traxanh.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div id="container">
        ...
        <div id="main">
            ...
            <div id="cont_left">
              	<img src="hinh/sp/bột/bottraxanh.jpg"/>
              </div>
              <div id="cont_right">
				...
				include "autoload.php";
              	...
              	<div id="cont">
                    	&nbsp;&nbsp;&nbsp;&nbsp;Thành Phần: 100% từ lá trà xanh nguyên chất.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;Công Dụng:<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;-  Giúp da mịn và tươi sáng.<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;-Tăng cường collagen, trị nám.<br/>
